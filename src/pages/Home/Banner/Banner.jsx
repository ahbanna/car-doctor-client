  ...
  return (
    <div className="carousel w-full h-[600px]">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        <div className="absolute flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[gradient(rgba(21, 21, 21, 0)] rounded-xl">
          <div className="text-white space-y-7 w-2/3 pl-10">
            ...
            <div>
              ...
              <button class="btn btn-primary">Latest Projects</button>
            </div>
          </div>
        </div>
